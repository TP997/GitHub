...
const Employee = ({employee, deleteEmployee}) => {
    ...
    className="text-left px-6 py-4 whitespace-nowrap"> 
     <div className='text-sm text-gray-500'>{employee.firstName}
     </div>
    </td> 

     <td 
     className="text-left px-6 py-4 whitespace-nowrap"> 
     <div className='text-sm text-gray-500'>{employee.lastName}
     </div>
     </td> 
   
     <td 
     className="text-left px-6 py-4 whitespace-nowrap"> 
     <div className='text-sm text-gray-500'>{employee.emailId} 
    </div>
     </td> 
