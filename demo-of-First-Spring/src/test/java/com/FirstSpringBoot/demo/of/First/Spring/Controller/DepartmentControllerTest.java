...
class DepartmentControllerTest {
    ...
    @BeforeEach
    void setUp() {
        department=Department.builder().departmentAddress("Banglore").departmentCode("IT-06").departmentName("IT").departmentId(1L).build();

    }

    @Test
    void saveDepartment() throws Exception {
       Department inputDepartment=Department.builder().departmentAddress("Banglore").departmentCode("IT-06").departmentName("IT").build();
